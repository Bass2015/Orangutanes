...
class SubjectDashboard:
    ...
    def boxplot(self):
        chart = Boxplot(self.subject, title='Mean time in behavior', df=self.df)
...
class Boxplot(Chart):
    ...
    def figure(self):
        ...
        self.fig = px.box(df, x='period', y='duration', color='period', width=500, title='Individual')
        self.update_layout(self.fig, title='Mean time with behavior', lgd_title=None)
